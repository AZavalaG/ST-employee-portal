...
const PersonalInfo = () => {
    return(
        <div className={styles.pi}>
            ...
            <h2 className={`${styles['title-first-name']}`}>< NavLink to="/ProfileUser">Nombre</NavLink></h2>
            <h2 className={`${styles['title-last-name']}`}>< NavLink to="/ProfileUser">Apellido </NavLink></h2>
